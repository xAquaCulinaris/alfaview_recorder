...
def write_config():
    ...
    config['DEFAULT'] = {'username': 'Marian', 'room': 'in-02', 'screenWidth': '1920','screenHeight': '1080','chromedriverPath': '/home/marian/Desktop/programming/alfaview_recorder/chromedriver', 'outputFile': 'video.mp4'}
    config['Alfaview'] = {'alfaviewWidth': '1920', 'alfaviewHeight': '1080', 'alfaviewSkipUpdate': 'true'}
